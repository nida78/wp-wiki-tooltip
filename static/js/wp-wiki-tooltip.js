...
function add_wiki_box( id, wid, title, wurl, thumb ) {
            ...
            if( origin.data( 'ajax' ) !== 'cached' ) {
                ...
                $wwtj.post( wp_wiki_tooltip.wp_ajax_url, request_data, function( response_data ) {
                    ...
                    if( data[ 'code' ] == -1 ) {
                        ...
                        origin.tooltipster( 'content', create_tooltip_message( 'ok', data[ 'title' ], data[ 'content' ], data[ 'thumb' ], data[ 'thumb-width' ], data[ 'thumb-height' ] ) ).data( 'ajax', 'cached' );
                    }
                });
            }
        }
...
function create_tooltip_message( type, title, message, thumb, w, h ) {
